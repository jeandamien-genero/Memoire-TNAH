...
Plusieurs voies sont envisagés pour répondre à ces nécessités. Aucune n'a pu être mise en place au cours de notre stage, mais nous avons mené plusieurs réflexions et quelques actions en leur sens. Nous allons d'abord présenter celles qui concernent les objets graphiques, puis nous intéresser à l'état des transcription, avant de conclure sur les différents types d'édition possibles et ce qu'elles impliquent pour les données issues du traitement automatique des fichiers des \odm.
