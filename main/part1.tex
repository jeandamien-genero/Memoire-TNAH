...
Le principe retenu est le suivant : chaque division de la structure est enchâssée dans un élément \citecode{<div>} pour lequel la valeur de l'attribut \citecode{@type} vient préciser son niveau. Ces valeurs sont calquées sur les divisions des documents du langage de composition \LaTeX{} : \citecode{\textbackslash chapter\{\}}, \citecode{\textbackslash section\{\}}, \citecode{\textbackslash subsection\{\}}, \citecode{\textbackslash subsubsection\{\}}. Cela a pour but de faciliter une éventuelle transformation des documents XML-TEI au format \LaTeX\footcite[p. 52]{chague2}.
