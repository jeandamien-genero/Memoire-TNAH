...
\begin{figure}
    ...
    \caption{Exemple d'une ensemble \citecode{<facsimile>} dans le fichier source du troisième volume de la deuxième série.}
    \label{fig:facsimile}
\end{figure}
...
La dernière section de l'arbre, \citecode{<text>}, contient les transcriptions structurées au sein de son élément \citecode{<body>}. Notons que l'implémentation de la structure logique par \lse{} n'a pas donné de résultats satisfaisants et a fait l'objet d'une reprise majeure lors du stage. 
